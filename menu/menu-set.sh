...
echo -e " \033[34m│\e[0m [\e[36m•23\e[0m] DNS Halium"
echo -e " \033[34m│\e[0m [\e[36m•24\e[0m] DNS Netflix, iQiyi, YouTube, Tiktok, Stream"
echo -e " \033[34m│\e[0m [\e[36m•25\e[0m] Cliear Ceche"
echo -e " \033[34m│\e[0m [\e[36m•26\e[0m] Reboot"
echo -e " \033[33m╭══════════════════════════════════════════════════════════╮\e[0m"
echo -e " \033[33m│$NC\033[33m          JENGKOLONLINE SYSTEM INSTALL PROXY        $NC\033[35m│\e[0m"
echo -e " \033[33m╰══════════════════════════════════════════════════════════╯\e[0m"
echo -e " \033[34m╭══════════════════════════════════════════════════════════╮\e[0m"
echo -e " \033[34m│\e[0m [\e[36m•27\e[0m] Install Proxy Port 8880"
echo -e " \033[34m│\e[0m [\e[36m•28\e[0m] Install Proxy VPN"
...
25) clear ; clearcache ;;
26) clear ; reboot ;;
27) clear ; wget https://raw.githubusercontent.com/Jengkolonline/tunneljengkolonline/main/sshws/nontls.sh && chmod +x nontls.sh && ./nontls.sh ;;
28) clear ; wget https://raw.githubusercontent.com/Jengkolonline/vpn/main/vpn.sh && chmod +x vpn.sh && ./vpn.sh ;;
