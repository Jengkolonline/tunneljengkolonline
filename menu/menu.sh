...
echo -e "                     \033[33m╰═════════════════════╯\e[0m"
echo -e " \033[32m╭══════════════════════════════════════════════════════════╮${NC}"
echo -e " \033[32m│\e[0m [\e[36m01\e[0m] SSH & OpenVPN Menu     \033[32m│\e[0m [\e[36m09\e[0m] Socks5 Menu           $NC\033[32m│$NC"
echo -e " \033[32m│\e[0m [\e[36m02\e[0m] Vmess Menu             \033[32m│\e[0m [\e[36m10\e[0m] L2TP Menu             $NC\033[32m│$NC"
echo -e " \033[32m│\e[0m [\e[36m03\e[0m] Vless Menu             \033[32m│\e[0m [\e[36m11\e[0m] PPTP Menu             $NC\033[32m│$NC"
echo -e " \033[32m│\e[0m [\e[36m04\e[0m] Trojan GFW Menu        \033[32m│\e[0m [\e[36m12\e[0m] SSTP Menu             $NC\033[32m│$NC"
echo -e " \033[32m│\e[0m [\e[36m05\e[0m] Shadowsoks Menu        \033[32m│\e[0m [\e[36m13\e[0m] SHADOWSOKS R Menu     $NC\033[32m│$NC"
echo -e " \033[32m│\e[0m [\e[36m06\e[0m] Install UDP            \033[32m│\e[0m [\e[36m14\e[0m] SHADOWSOKS-Libev Menu $NC\033[32m│$NC"
echo -e " \033[32m│\e[0m [\e[36m07\e[0m] Psiphon Pro            \033[33m│\e[0m [\e[36m15\e[0m] WIREGUARD Menu        $NC\033[32m│$NC"
echo -e " \033[32m│\e[0m [\e[36m08\e[0m] Shadowsoks 2022        \033[33m│\e[0m [\e[36m16\e[0m] SYSTEM Menu           $NC\033[32m│$NC"
echo -e " \033[32m╰══════════════════════════════════════════════════════════╯${NC}"
echo -e " \033[34m╭══════════════════════════════════════════════════════════╮${NC}"
...
7) clear ; wget ${PS} && chmod +x testa.sh && ./testa.sh ;;
8) clear ; shadowsocks2022 ;;
9) clear ; socks ;;
10) clear ; menu-l2tp ;;
11) clear ; menu-pptp ;;
12) clear ; menu-sstp ;;
