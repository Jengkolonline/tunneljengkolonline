...
NUMBER_OF_CLIENTS=$(grep -c -E "^### " "/etc/vmess/.vmess.db")
        if [[ ${NUMBER_OF_CLIENTS} == '0' ]]; then
                clear
        echo -e "\033[35m╔════════════════════════\033[31mक⊹⊱\033[33mꕥ\033[32m⊰⊹क\033[35m═══════════════════════╗\e[0m"
        echo -e "\033[35m║\E[0;100;33m                 \033[31m• \033[33mEdit Quotq Vmess \033[32m•                 \E[0m\033[35m║"
        echo -e "\033[35m╚════════════════════════\033[31mक⊹⊱\033[33mꕥ\033[32m⊰⊹क\033[35m═══════════════════════╝\e[0m"
                echo ""
    ...
    clear
    echo -e "\033[35m╔════════════════════════\033[31mक⊹⊱\033[33mꕥ\033[32m⊰⊹क\033[35m═══════════════════════╗\e[0m"
    echo -e "\033[35m║\E[0;100;33m                  \033[31m• \033[33mSukses Edit Quotq \033[32m•                   \E[0m\033[35m║"
    echo -e "\033[35m╚════════════════════════\033[31mक⊹⊱\033[33mꕥ\033[32m⊰⊹क\033[35m═══════════════════════╝\e[0m"
    echo ""
...
NUMBER_OF_CLIENTS=$(grep -c -E "^### " "/etc/vmess/.vmess.db")
        if [[ ${NUMBER_OF_CLIENTS} == '0' ]]; then
                clear
        echo -e "\033[35m╔════════════════════════\033[31mक⊹⊱\033[33mꕥ\033[32m⊰⊹क\033[35m═══════════════════════╗\e[0m"
        echo -e "\033[35m║\E[0;100;33m                 \033[31m• \033[33mEdit Limit Vmess \033[32m•                 \E[0m\033[35m║"
        echo -e "\033[35m╚════════════════════════\033[31mक⊹⊱\033[33mꕥ\033[32m⊰⊹क\033[35m═══════════════════════╝\e[0m"
                echo ""
                echo ""
                echo "You have no existing clients!"
...
NUMBER_OF_CLIENTS=$(grep -c -E "^### " "/etc/vmess/.vmess.db")
        if [[ ${NUMBER_OF_CLIENTS} == '0' ]]; then
                clear
        echo -e "\033[35m╔════════════════════════\033[31mक⊹⊱\033[33mꕥ\033[32m⊰⊹क\033[35m═══════════════════════╗\e[0m"
        echo -e "\033[35m║\E[0;100;33m                 \033[31m• \033[33mReset Quotq Vmess \033[32m•                 \E[0m\033[35m║"
        echo -e "\033[35m╚════════════════════════\033[31mक⊹⊱\033[33mꕥ\033[32m⊰⊹क\033[35m═══════════════════════╝\e[0m"
