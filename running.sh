...
echo -e "         OWNER : ${GREEN}OTTIN NETWORK ${NC}${YELLOW}(${NC} ${GREEN}Jengkol Online ${NC}${YELLOW})${NC}"
echo -e "       © By JengkolOnline ${YELLOW}(${NC} 2022-2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
...
echo -e "Vmess WS            = $status_ss"
echo -e "Vmess None WS       = $status_ss"
echo -e "Vmess GRPC          = $status_ss"
echo -e "Vless WS            = $status_ss"
echo -e "Vless None WS       = $status_ss"
echo -e "Vless GRPC          = $status_ss"
echo -e "Trojan WS           = $status_ss"
echo -e "Trojan None WS      = $status_ss"
echo -e "Trojan GRPC         = $status_ss"
